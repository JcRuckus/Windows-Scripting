...
START "net48_offline_installer_ndp48-x86-x64-allos-enu"
CD..
ECHO ===================================================================================
...
START DMSFileClient.msi /silent
...
START "C:\Program Files (x86)\ErrorProof\FTCRegistrySettings.exe"
...
Dism /Online /Add-Capability /CapabilityName:Language.TextToSpeech~~~pt-BR~0.0.1.0
...
"C:\Program Files\Common Files\Microsoft Shared\ClickToRun\OfficeC2RClient.exe" /update user updatepromptuser=true forceappshutdown=true displaylevel=true
	...
	REM nothing... absolutely nothing, wow!
...
::::::Set Current Folder as working folder in script
::CD /d %~dp0
